...
export const metadata: Metadata = {
  title: 'Beacon vs FACTS',
  description:
    'Honest comparison: Beacon vs FACTS for independent schools. Family Desk communications, Dinner Table Digests, and school-owned tuition — without the portal black hole.',
  alternates: { canonical: '/vs/facts' },
  openGraph: {
    title: 'Beacon vs FACTS — for schools that want families to open the app',
    description:
      'FACTS owns tuition scale. Beacon owns calm family communications and honest ops. See the side-by-side.',
    url: '/vs/facts',
  },
  keywords: [
    'Beacon vs FACTS',
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground">
          FACTS (Nelnet) is the scale leader for private-school tuition — about{' '}
          <strong className="text-foreground">{FACTS_SCALE.schools} schools</strong> and{' '}
          <strong className="text-foreground">{FACTS_SCALE.families} families</strong> on their claim.
          Beacon is not trying to out-module them. We’re going after the wound schools feel every
          week: <em>families don’t open the portal, and the office can’t prove communications landed.</em>
        </p>
        ...
        <section className="mt-14">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Honest edges — where FACTS still wins, and where Beacon takes the fight.
          </p>
        ...
        <section className="mt-14 grid gap-10 border-t border-border pt-14 lg:grid-cols-2">
          <div>
            <h2 className="text-xl font-semibold tracking-tight text-foreground">
              Leaving FACTS? Start with the family layer
            </h2>
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              Many schools keep FACTS tuition for a season and still need a better family
          ...
          <div className="rounded-2xl border border-border/80 bg-card p-5 sm:p-6">
            ...
            <h3 className="mt-1 text-lg font-semibold text-foreground">Talk with us</h3>
            <p className="mt-1 mb-4 text-sm text-muted-foreground">
              Tell us you’re on FACTS (or evaluating). We’ll reply by email — no sales theater.
            </p>
