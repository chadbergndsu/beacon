...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-2xl space-y-8 animate-beacon-in">
      <div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
                ...
                <strong className="text-foreground">Chris Cowan</strong> — the vision, priorities,
                and push to make grades transparent for families and effortless for teachers.
              </p>
            </div>
          </div>
